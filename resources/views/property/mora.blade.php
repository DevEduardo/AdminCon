...
<div class="col-md-4">
	<div class="card">
	  <div class="card-body row justify-content-center">
	    <h4 class="card-title text-center teal-text">Inmuebles en mora</h4>
	    <form action="{{ url('mora')}}" method="POST" class="col-md-12">
           {{ csrf_field() }}
            ...
            <div class="modal-footer d-flex justify-content-center">
                ...
                <button type="submint" class="btn btn-default">Agregar mora</button>
            </div>
        </form>
	  </div>
	</div>
